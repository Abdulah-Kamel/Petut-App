  ...
  if (!user) {
    return (
      <div className="flex flex-col items-center justify-center h-screen p-8 bg-gray-50">
        ...
        <h2 className="text-2xl font-bold mb-4 text-gray-800">Join the Conversation!</h2>
        <p className="text-gray-600 text-center mb-8">Sign in to start chatting with other pet lovers</p>
  ...
  if (selectedChat) {
    return (
        ...
        <div className="h-full flex flex-col max-w-4xl mx-auto">
          <div className="bg-white border-b p-4 flex items-center flex-shrink-0">
            <button
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex flex-col items-end ml-2">
                      <span className={`text-xs ${isUnread ? 'text-blue-500 font-bold' : 'text-gray-500'}`}>
                        {formatTime(chat.lastMessageTime)}
                      </span>
                      {isUnread && (
                        <div className="bg-blue-500 text-white text-xs rounded-full px-2 py-1 mt-1 min-w-[20px] text-center">
