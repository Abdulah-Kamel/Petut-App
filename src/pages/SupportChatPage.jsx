...
const SupportChatPage = () => {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      case 'open': return 'bg-blue-800 text-blue-200';
      case 'in_progress': return 'bg-orange-800 text-orange-200';
      case 'closed': return 'bg-[#313340] text-gray-300';
      default: return 'bg-[#313340] text-gray-300';
    }
  };
  ...
  return (
    <div className="min-h-screen bg-secondary-dark">
      {/* Header */}
      <div className="bg-[#313340] shadow-sm border-b border-gray-700">
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <button
                onClick={() => navigate('/my-tickets')}
                className="mr-4 p-2 hover:bg-gray-600 rounded-full text-white"
              >
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        <div className="bg-[#313340] rounded-lg shadow-lg h-[600px] overflow-y-auto p-4 mb-4 space-y-4">
                ...
                <div
                  className={`max-w-xs lg:max-w-md px-4 py-3 rounded-lg shadow-sm relative ${
                    isMe
                      ...
                      : 'bg-gray-600 text-gray-200 rounded-r-2xl rounded-tl-2xl rounded-bl-md'
                  }`}
                >
        ...
        {ticket.status !== 'closed' && (
          <div className="bg-[#313340] rounded-lg shadow-lg p-4">
            <div className="flex gap-3">
              <input
                ...
                className="flex-1 px-4 py-2 border border-gray-600 rounded-lg focus:ring-2 focus:ring-primary_app focus:border-transparent bg-gray-700 text-white placeholder-gray-400"
                disabled={isLoading}
              />
              <button
                onClick={sendMessage}
        ...
        {ticket.status === 'closed' && (
          <div className="bg-[#313340] rounded-lg p-4 text-center">
            <p className="text-gray-300">This ticket has been closed. No new messages can be sent.</p>
          </div>
        )}
      </div>
    </div>
